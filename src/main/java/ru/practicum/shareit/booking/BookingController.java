...
public class BookingController {
	...
	@PostMapping
	public BookingDto createBooking(@Validated({BasicInfo.class}) @RequestBody RequestBookingDto booking,
	...
	@GetMapping("/owner")
	public Collection<BookingDto> getBookingsForUsersItems(@RequestHeader(SHARER_USER_ID) long userId,
														   @RequestParam(required = false, defaultValue = "all") String status) {
		return bookingService.getBookingsForUsersItems(userId, status);
	}
}
